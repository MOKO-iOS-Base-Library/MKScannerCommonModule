//
//  MKScannerRemoteReminderController.m
...
@interface MKScannerRemoteReminderController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKScannerRemoteReminderModel *dataModel;

@property (nonatomic, strong)id <MKScannerRemoteReminderProtocol>protocol;

@end

@implementation MKScannerRemoteReminderController

- (void)dealloc {
    NSLog(@"MKScannerRemoteReminderController销毁");
}
...
- (void)reminderLED {
    ...
    @weakify(self);
    [self.protocol ledRemoteReminderWithBlinkingTime:[self.dataModel.blinkingTime integerValue]
...
- (void)reminderVibration {
    ...
    [[MKHudManager share] showHUDWithTitle:@"Config..." inView:self.view isPenetration:NO];
    @weakify(self);
    [self.protocol vibrateRemoteReminderWithVibratingTime:[self.dataModel.vibrationTime integerValue]
                                        vibrationInterval:[self.dataModel.vibrationInterval integerValue]
                                                 sucBlock:^{
        @strongify(self);
        [[MKHudManager share] hide];
        [self.view showCentralToast:@"Success"];
...
- (MKScannerRemoteReminderModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKScannerRemoteReminderModel alloc] init];
    }
    return _dataModel;
}
