//
//  MKScannerButtonDfuV2Controller.m
...
@interface MKScannerButtonDfuV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerButtonDfuV2Protocol>protocol;
...
@implementation MKScannerButtonDfuV2Controller

- (void)dealloc {
    NSLog(@"MKScannerButtonDfuV2Controller销毁");
}
...
- (void)loadSectionDatas {
    ...
    if (self.protocol.type != 5 && self.protocol.type != 6) {
        //BXP-T和BXP-S没有此选项
