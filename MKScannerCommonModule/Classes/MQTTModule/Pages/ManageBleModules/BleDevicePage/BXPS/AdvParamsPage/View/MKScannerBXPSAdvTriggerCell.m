...
@implementation MKScannerBXPSAdvTriggerCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKScannerBXPSAdvTriggerCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKScannerBXPSAdvTriggerCell ()
...
@implementation MKScannerBXPSAdvTriggerCell

+ (MKScannerBXPSAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKScannerBXPSAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKScannerBXPSAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKScannerBXPSAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKScannerBXPSAdvTriggerCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKScannerBXPSAdvTriggerCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_scanner_BXPSAdvTriggerCell_setPressed:interval:txPower:)]) {
        [self.delegate mk_scanner_BXPSAdvTriggerCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKScannerBXPSAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKScannerBXPSAdvTriggerCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKScannerBXPSAdvTriggerCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKScannerBXPSAdvTriggerCellSlotType)slotType {
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKScannerBXPSAdvTriggerCellSlotTypeTHInfo) {
        return @"T&H info";
    }
