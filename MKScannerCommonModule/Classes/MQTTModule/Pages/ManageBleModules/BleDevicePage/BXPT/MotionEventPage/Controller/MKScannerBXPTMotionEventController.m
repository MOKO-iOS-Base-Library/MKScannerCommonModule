//
//  MKScannerBXPTMotionEventController.m
...
@interface MKScannerBXPTMotionEventController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerBXPTMotionEventProtocol>protocol;

@end

@implementation MKScannerBXPTMotionEventController

- (void)dealloc {
    NSLog(@"MKScannerBXPTMotionEventController销毁");
}
