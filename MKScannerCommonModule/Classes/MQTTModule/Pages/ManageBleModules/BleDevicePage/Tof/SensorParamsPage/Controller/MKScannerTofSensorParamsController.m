//
//  MKScannerTofSensorParamsController.m
...
@interface MKScannerTofSensorParamsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerTofSensorParamsProtocol>protocol;

@end

@implementation MKScannerTofSensorParamsController

- (void)dealloc {
    NSLog(@"MKScannerTofSensorParamsController销毁");
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 0) {
        //Ranging mode
        self.protocol.distanceMode = dataListIndex;
...
- (void)loadSection0Datas {
    ...
    cellModel1.textFieldValue = self.protocol.interval;
    ...
    cellModel2.textFieldValue = self.protocol.count;
    ...
    cellModel3.textFieldValue = self.protocol.time;
    cellModel3.unit = @"ms";
...
- (void)loadSection1Datas {
    ...
    cellModel.dataListIndex = self.protocol.distanceMode;
