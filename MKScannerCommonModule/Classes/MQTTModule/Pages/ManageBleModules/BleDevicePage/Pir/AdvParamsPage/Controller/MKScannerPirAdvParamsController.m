//
//  MKScannerPirAdvParamsController.m
...
@interface MKScannerPirAdvParamsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerPirAdvParamsProtocol>protocol;

@end

@implementation MKScannerPirAdvParamsController

- (void)dealloc {
    NSLog(@"MKScannerPirAdvParamsController销毁");
}

- (instancetype)initWithProtocol:(id<MKScannerPirAdvParamsProtocol>)protocol {
    if (self = [super init]) {
        _protocol = protocol;
    }
    return self;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerPirAdvParamsController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
