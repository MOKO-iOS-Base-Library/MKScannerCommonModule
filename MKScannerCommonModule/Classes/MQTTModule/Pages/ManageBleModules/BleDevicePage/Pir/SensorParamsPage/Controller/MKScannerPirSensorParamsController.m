//
//  MKScannerPirSensorParamsController.m
...
@interface MKScannerPirSensorParamsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerPirSensorParamsProtocol>protocol;

@end

@implementation MKScannerPirSensorParamsController

- (void)dealloc {
    NSLog(@"MKScannerPirSensorParamsController销毁");
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 1) {
        //PIR Delay
        self.protocol.delay = dataListIndex;
...
- (void)loadSectionDatas {
    ...
    cellModel1.dataListIndex = self.protocol.sensitivity;
    ...
    cellModel2.dataListIndex = self.protocol.delay;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerPirSensorParamsController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
