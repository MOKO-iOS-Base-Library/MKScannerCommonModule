//
//  MKScannerBXPDAccParamsController.m
...
@interface MKScannerBXPDAccParamsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerBXPDAccParamsProtocol>protocol;

@end

@implementation MKScannerBXPDAccParamsController

- (void)dealloc {
    NSLog(@"MKScannerBXPDAccParamsController销毁");
}

- (instancetype)initWithProtocol:(id<MKScannerBXPDAccParamsProtocol>)protocol {
    if (self = [super init]) {
        _protocol = protocol;
    }
    return self;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerBXPDAccParamsController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
