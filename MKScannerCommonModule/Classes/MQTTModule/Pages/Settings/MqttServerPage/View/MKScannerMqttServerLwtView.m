...
@implementation MKScannerMqttServerLwtViewModel
@end

@interface MKScannerMqttServerLwtView ()
...
@implementation MKScannerMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchSelectedIcon.png") : LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchSelectedIcon.png") : LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKScannerMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKScannerMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerMqttServerLwtView", @"mk_scanner_switchUnselectedIcon.png") forState:UIControlStateNormal];
