//
//  MKScannerCommunicateController.m
...
@interface MKScannerCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)id <MKScannerCommunicateProtocol>protocol;

@end

@implementation MKScannerCommunicateController

- (void)dealloc {
    NSLog(@"MKScannerCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerCommunicateController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
