//
//  MKScannerDataReportController.m
...
@interface MKScannerDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)id <MKScannerDataReportProtocol>protocol;

@end

@implementation MKScannerDataReportController

- (void)dealloc {
    NSLog(@"MKScannerDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerDataReportController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
