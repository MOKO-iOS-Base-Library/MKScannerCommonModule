//
//  MKScannerFilterByTofController.m
...
@interface MKScannerFilterByTofController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerFilterByTofProtocol>protocol;

@end

@implementation MKScannerFilterByTofController

- (void)dealloc {
    NSLog(@"MKScannerFilterByTofController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerFilterByTofController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
