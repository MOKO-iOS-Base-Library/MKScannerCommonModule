//
//  MKScannerFilterByAdvNameController.m
...
@interface MKScannerFilterByAdvNameController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerFilterByAdvNameProtocol>protocol;

@end

@implementation MKScannerFilterByAdvNameController
...
- (void)configDataToDevice {
    ...
    @weakify(self);
    [self.protocol configDataWithNameList:nameList sucBlock:^{
        @strongify(self);
        [[MKHudManager share] hide];
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerFilterByAdvNameController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
