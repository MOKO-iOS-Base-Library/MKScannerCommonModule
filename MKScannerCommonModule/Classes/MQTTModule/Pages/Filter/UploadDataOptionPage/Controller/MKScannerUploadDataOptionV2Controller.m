//
//  MKScannerUploadDataOptionV2V2Controller.m
...
@interface MKScannerUploadDataOptionV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerUploadDataOptionV2Protocol>protocol;

@end

@implementation MKScannerUploadDataOptionV2Controller

- (void)dealloc {
    NSLog(@"MKScannerUploadDataOptionV2Controller销毁");
}
...
- (void)loadSectionDatas {
    ...
    if (self.protocol.isV2) {
        ...
        cellModel2.index = 3;
        cellModel2.msg = @"ADV data";
        cellModel2.isOn = self.protocol.adv_data;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerUploadDataOptionV2Controller", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
