//
//  MKScannerFilterByURLController.m
...
@interface MKScannerFilterByURLController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerFilterByURLProtocol>protocol;

@end

@implementation MKScannerFilterByURLController

- (void)dealloc {
    NSLog(@"MKScannerFilterByURLController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel1.textFieldValue = self.protocol.url;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerFilterByURLController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
