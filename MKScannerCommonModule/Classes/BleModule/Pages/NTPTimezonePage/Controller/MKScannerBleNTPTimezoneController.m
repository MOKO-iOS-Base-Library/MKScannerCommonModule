//
//  MKScannerBleNTPTimezoneController.m
...
@interface MKScannerBleNTPTimezoneController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerBleNTPTimezoneProtocol>protocol;

@property (nonatomic, strong)NSMutableArray *timezoneList;

@end

@implementation MKScannerBleNTPTimezoneController

- (void)dealloc {
    NSLog(@"MKScannerBleNTPTimezoneController销毁");
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 0) {
        //Timezone
        self.protocol.timeZone = dataListIndex;
...
- (void)loadSection0Datas {
    ...
    cellModel.textFieldValue = self.protocol.ntpHost;
...
- (void)loadSection1Datas {
    ...
    cellModel.dataListIndex = self.protocol.timeZone;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerBleNTPTimezoneController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
