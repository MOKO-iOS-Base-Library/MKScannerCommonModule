//
//  MKScannerBleBeaconController.m
...
@interface MKScannerBleBeaconController ()<UITableViewDelegate,
...
@property (nonatomic, strong)id <MKScannerBleBeaconProtocol> protocol;

@end

@implementation MKScannerBleBeaconController

- (void)dealloc {
    NSLog(@"MKScannerBleBeaconController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerCommonModule", @"MKScannerBleBeaconController", @"mk_scanner_saveIcon.png") forState:UIControlStateNormal];
