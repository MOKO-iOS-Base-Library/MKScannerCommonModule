...
@implementation MKScannerBleNearbyWifiCellModel
@end

@interface MKScannerBleNearbyWifiCell ()
...
@implementation MKScannerBleNearbyWifiCell


+ (MKScannerBleNearbyWifiCell *)initCellWithTableView:(UITableView *)tableView {
    MKScannerBleNearbyWifiCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKScannerBleNearbyWifiCellIdenty"];
    if (!cell) {
        cell = [[MKScannerBleNearbyWifiCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKScannerBleNearbyWifiCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKScannerBleNearbyWifiCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKScannerBleNearbyWifiCellModel.class]) {
        return;
    }
    //顶部
