...
@implementation MKScannerAdvNormalCellModel
@end

@interface MKScannerAdvNormalCell ()
...
@implementation MKScannerAdvNormalCell

+ (MKScannerAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKScannerAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKScannerAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKScannerAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKScannerAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_scanner_advNormalCell_setPressed:interval:txPower:)]) {
...
#pragma mark - setter
- (void)setDataModel:(MKScannerAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKScannerAdvNormalCellModel.class]) {
        return;
    }
