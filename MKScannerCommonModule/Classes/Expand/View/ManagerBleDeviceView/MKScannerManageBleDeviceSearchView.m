//
//  MKScannerManageBleDeviceSearchView.m
...
@interface MKScannerManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKScannerManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKScannerManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKScannerManageBleDeviceSearchView *view = [[MKScannerManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKScannerCommonModule", @"MKScannerManageBleDeviceSearchView", @"mk_scanner_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKScannerCommonModule", @"MKScannerManageBleDeviceSearchView", @"mk_scanner_wifiGraySignalIcon.png");
    }
