...
@implementation MKScannerAlertViewModel
@end

@interface MKScannerAlertView ()
...
@implementation MKScannerAlertView

- (void)dealloc {
    NSLog(@"MKScannerAlertView销毁");
}
...
- (void)showWithModel:(MKScannerAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKScannerAlertViewModel.class]) {
        return;
    }
