//
//  MKScannerImportServerController.m
...
@interface MKScannerImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKScannerImportServerController

- (void)dealloc {
    NSLog(@"MKScannerImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_scanner_selectedServerParams:)]) {
        [self.delegate mk_scanner_selectedServerParams:model.leftMsg];
    }
